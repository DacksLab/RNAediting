...
parser = argparse.ArgumentParser(
    description = "Calls the GRAVY program for one or more files",
    epilog = """This program allows for batch calls of the GRAVY calculation
    program. If files have routine structure and are named in a consistent
    manner including information such as gene name then a simple wrapper
    script such as this can easily automate largescale analysis""")
...
for infile in args.infiles:
    ...
    subprocess.call(["/Users/cklinger/git/Rediting/rediting/calculate_gravy_scores.py",
            "-in", infile, "-out", out, "-g", gene, "-r", rna, "-gen", gen])
