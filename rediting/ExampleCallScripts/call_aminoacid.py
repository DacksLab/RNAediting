...
parser = argparse.ArgumentParser(
    description = "Calls the amino acid program for one or more files",
    epilog = """This program allows for batch calls of the AA comparison
...
for infile in args.infiles:
    ...
    subprocess.call(["/Users/cklinger/git/Rediting/compare_aminoacids.py",
