...
def canonical_bases(base1, base2, bset=('A','G','T','C')):
    """Returns True if both bases fall in a given set"""
    if (base1 in bset and base2 in bset):
        return True
    return False


def compare_seqs(seq1, seq2, num_equal):
    """Compare amino acid substrings to determine start of alignment"""
    #print seq1
    #print seq2
    #print
    equal = 0
...
def compare_nuc_seqs(base1, base2):
    """Compare nucleotide substrings to determine start of alignment"""
    if base1 != '-' and base2 != '-':
        return True
    return False
